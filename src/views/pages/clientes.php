...
<div class="container pt-5">
	...
	<div class="float-left" >
			<a class="btn btn-success pl-5 pr-5" href="<?=$base;?>/clientes?cadastrar" role="button">ADICIONAR</a>
  ...
  <tbody>
    <tr>
      ...
      foreach($clientes as $lista){   ?>
        ...
        <td> <a href="<?php echo $base ?>/clientes/<?php echo $lista['id']; ?> "> excluir </a> </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="<?=$base?>/clientes ">
